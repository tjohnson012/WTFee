...
import { LineItemExplanation } from '../../services/explanationService';
        ...
        <CardContent>
          <TotalGrid>
            <TotalItem $highlight>
              ...
              <TotalValue $large>{formatCurrency(analysis.totalCharged)}</TotalValue>
            </TotalItem>
            <TotalItem>
              <TotalLabel>Fair Market Value</TotalLabel>
              <TotalValue $color="#4CAF50">{formatCurrency(analysis.fairMarketValue)}</TotalValue>
            </TotalItem>
            <TotalItem>
              <TotalLabel>Items Analyzed</TotalLabel>
              <TotalValue>{result.lineItems.length}</TotalValue>
            </TotalItem>
            <TotalItem>
...
Fair Market Value:  ${formatCurrency(analysis.fairMarketValue)}
Potential Savings:  ${formatCurrency(analysis.potentialSavings)}
